    ...
    <div className="modal-backdrop" role="presentation" onMouseDown={onClose}>
      <section ref={dialogRef} className="modal" role="dialog" aria-modal="true" aria-labelledby="modal-title" onMouseDown={(event) => event.stopPropagation()}>
        ...
        {!submitted && <form onSubmit={(event) => { event.preventDefault(); void submitWaitlist() }}>
          ...
          <label className="consent"><input type="checkbox" checked={marketingConsent} onChange={(event) => { setMarketingConsent(event.target.checked); setError('') }} required /> <span>Aceito que meus dados sejam utilizados pelo AçõesJA para o envio de avisos, novidades e informações relacionadas à plataforma e ao lançamento do Professor IA. Consulte os <a href="https://www.acoesja.com.br/termos" target="_blank" rel="noreferrer">Termos de Uso</a> e a <a href="https://www.acoesja.com.br/privacidade" target="_blank" rel="noreferrer">Política de Privacidade</a>.</span></label>
